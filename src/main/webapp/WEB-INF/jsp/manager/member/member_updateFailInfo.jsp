...
<title>member changeConfig</title>
</head>
	...
	<center>
		<form method="POST" action="memberChangeConfig" name="form1">
			...
			<table width="791" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td height="63"><div align="center"><h1>${info}<h1></div></td>
					<h3><a href="memberChange"><span id="jumpTo">5</span>秒后系统会自动跳转，也可点击本处直接跳</a></h3>
					<script type="text/javascript">
						countDown(3, 'memberChange');
					</script>
				</tr>
			</table>
